...
const style = {
   ...
   info_box:
      "bg-black/20 flex flex-col justify-between lg:min-h-[90vh]  min-h-[130vh] h-auto p-5 rounded-md shadow-md transition-transform transform hover:scale-105 duration-500",
   contact_btn:
